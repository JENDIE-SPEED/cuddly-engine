                    ...
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                <li><a title="Dashboard v.1" href="index-1.php"><span class="mini-sub-pro">Dashboard </span></a></li>
                                ...
                                <li><a title="Presenter list" href="presenter-list.php"><span class="mini-sub-pro">Presenter list</span></a></li>
                                <li><a title="Analytics" href="analytics.php"><span class="mini-sub-pro">Sales Analytics</span></a></li>
                            </ul>
                        </li>
                       
                        <li id="removable">
                            <a class="has-arrow" href="#" aria-expanded="false"><i class="icon treris-new-file icon-wrap"></i> <span class="mini-click-non">Pages</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                
                                <li><a title="Signup" href="signup.html"><span class="mini-sub-pro">Add Users</span></a></li>
                                <li><a title="Signup" href="send.php"><span class="mini-sub-pro">SEND TEXT</span></a></li>
                                <li><a title="Signup" href="assign.php"><span class="mini-sub-pro">ASSIGN PRESENTERS</span></a></li>
                            </ul>
                        </li>
                    </ul>
                </nav>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <div class="breadcomb-wp">
											...
											<div class="breadcomb-ctn">
												<h2>Product Edit</h2>
												<p>Welcome to treris <span class="bread-ntd"></span></p>
											</div>
										</div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">
                                <ul id="myTab3" class="tab-review-design">
                                    <li class="active"><a href="#description"><i class="icon treris-edit" aria-hidden="true"></i> Product Edit</a></li>
                                ...
                                <div id="myTabContent" class="tab-content custom-product-edit">
                                    <div class="product-tab-list tab-pane fade active in" id="description">
                                        <div class="row">
                                            <form action="add.php" method="post">
                                                ...
                                                <div class="review-content-section">
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="icon treris-user" aria-hidden="true"></i></span>
                                                        <input type="text" name="shortcode" class="form-control" placeholder="SHORT CODE">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="icon treris-edit" aria-hidden="true"></i></span>
                                                        <input type="text" name="title" class="form-control" placeholder="Product Title">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-usd" aria-hidden="true"></i></span>
                                                        <input type="text" name="price" class="form-control" placeholder="Regular Price">
                                                    </div>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    <div class="input-group mg-b-pro-edt"><li class="active"><i class="icon treris-edit" aria-hidden="true"></i> User</a></li>
                                                        <select name="user" class="form-control pro-edt-select form-control-primary"  >
                                                            ...
                                                            while ($row=mysqli_fetch_array($result)) {
                                                                # code...
                                                                ?>
                                                                <option value="<?php echo $row['secondname']; ?>"><?php echo $row['secondname']; ?></option>
                                                    ...
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="icon treris-favorites-button" aria-hidden="true"></i></span>
