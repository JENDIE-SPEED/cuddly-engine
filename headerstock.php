...
<body>
  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper" style="background-color:rgb(41, 37, 36);opacity:0.8;">
      ...
      <div class="sidebar-sticky pt-3">
        <a class="navbar-brand col-md-3 col-lg-2 mr-0 px-3" href="index-s.php"> <img src="assets/img/JEND.png"></a>
        <ul class="nav flex-column">
          <li class="nav-item dropdown">
            ...
            <a class="dropdown-item" href="addstock_s.php">Add Stock</a>
              <a class="dropdown-item" href="history.php">Cancel </a>
              <a class="dropdown-item" href="stockcancel.php">Stock Cancel </a>
  ...
  <div class="nav nav-tabs" id="nav-tab" role="tablist">
    <a class="nav-item nav-link active" id="nav-home-tab" href="index-s.php"  >Home</a>
