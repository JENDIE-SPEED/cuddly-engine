...
$user=  $_SESSION['user'];
  function sequence(){
    ...
    if ($content ==99999){
        ...
        file_put_contents("/opt/lampp/htdocs/ruby/jendiegovernor/letter_number",$letter_number);
    }
    file_put_contents("/opt/lampp/htdocs/ruby/jendiegovernor/seq_file",$content);
