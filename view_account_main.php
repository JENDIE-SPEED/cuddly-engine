...
if(isset($_POST["query"]))
{
 ...
 $query = "SELECT * from client_account WHERE username LIKE '%".$search."%' OR password LIKE '%".$search."%'  order by id DESC limit 10
   ";
}
else
{
 $query = "
  SELECT * from client_account  order by id DESC limit 10
 ";
}
